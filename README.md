...
## SQL queries
SQL queries for the following bullet points are available [here](https://github.com/nav-01/fetch_rewards_exc/blob/main/fetch_rewards_nb.ipynb) under the 'SQL Queries' section.
